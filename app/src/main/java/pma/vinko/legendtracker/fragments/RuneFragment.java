...
public class RuneFragment extends Fragment {
    ...
    private String url = "https://global.api.pvp.net/api/lol/static-data/eune/v1.2/rune?runeListData=all&api_key=RGAPI-CBA5D9B2-7ED7-42FB-A7F0-D312B30965EA ";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_rune, container, false);

        TableLayout tl = (TableLayout) rootView.findViewById(R.id.runesTable);

        new PopulateTable(getActivity(), rootView, tl, RuneDetailsActivity.class, "name", 29).execute(url);
        return rootView;
    }
